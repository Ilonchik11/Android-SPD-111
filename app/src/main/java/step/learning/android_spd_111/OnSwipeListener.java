...
public class OnSwipeListener implements View.OnTouchListener {
    ...
    public OnSwipeListener(Context context) {
        /*
        Детектор жестів створюється у контексті - він обмежений цим контекстом
        та передає до його обробників. У якості контексту має бути View, свайпи
        по якому аналізуються.
         */
    ...
    private final class SwipeGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onFling(@Nullable MotionEvent e1, @NonNull MotionEvent e2, float velocityX, float velocityY) {
            ...
            if(e1 != null) {
                ...
                // abs(x) - модуль числа
                // відстань (без урахування знаку) по горизонталі більше, ніж
                ...
                else { // або верхній, або нижній свайп
...
Базові детектори жестів не налаштовані на розрізнення свайпів, для
них є узагальнений жест - Fling - торкання у точці e1, проведення та завершення
жесту у точці e2.
...
Також бажано встановити граничні значення, як до відстані проведення,
так і швидкості.
 */
